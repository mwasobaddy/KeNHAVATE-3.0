...
export default function Edit({ idea, categories }: EditIdeaProps) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        proposal_document_path: idea.proposal_document_path || '',
                    ...
                    <div className="space-y-8">
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Update the essential details about your idea
                                </CardDescription>
                            </CardHeader>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Update the problem definition and your proposed solution
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div>
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Update optional details to strengthen your idea
                                </CardDescription>
                            </CardHeader>
                            <CardContent className="space-y-4">
                                <div>
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        onChange={(e) => {
                                            return setData('proposal_document_path', e.target.value);
                                        }}
                        ...
                        <Card>
                            <CardHeader>
                                ...
                                <CardDescription>
                                    Manage collaboration settings for your idea
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
